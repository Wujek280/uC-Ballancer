...
// >napięcia za wysokiego zwraca '255'
// >napiecia za niskiego  zwraca '000'
// >napiecia operacyjnego LiIon  '0' do '100' % pojemności jako liczba całkowita (int)
